...
subhap <- read.table('/restricted/projectnb/cte/Challenge_Project_2022/imputation/neural_net/Prediction_data_updatedSD_PredResult.txt',
                     header = T, sep = ',', as.is = T)
subhap$H1B1G1 <- ifelse(subhap$Class == '0', 2, 
                             ifelse(subhap$Class == '1', 1, 0))
