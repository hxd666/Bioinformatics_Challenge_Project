...
batch1.subhap <- read.table('/restricted/projectnb/cte/Challenge_Project_2022/imputation/1st_batch/subhaplotypes/1st_batch.topmed.mapt.subhaplotypes.txt',
                            header = T, as.is = T)
batch1.subhap$TOPMed_ID <- sapply(batch1.subhap$TOPMed_ID, function(x){strsplit(x,'_')[[1]][1]})
batch1.subhap <- batch1.subhap[batch1.subhap$TOPMed_ID %in% pheno$pin[pheno$Batch=='I'], ]
batch1.subhap <- batch1.subhap[match(pheno$pin[pheno$Batch=='I'],batch1.subhap$TOPMed_ID),] 

batch2.subhap <- read.table('/restricted/projectnb/cte/Challenge_Project_2022/imputation/2nd_batch/subhaplotypes/2nd_batch.topmed.mapt.subhaplotypes.txt',
                            header = T, as.is = T)
batch2.subhap$TOPMed_ID[batch2.subhap$TOPMed_ID == 'k-0487'] <- "K-0487"
batch2.subhap$TOPMed_ID[batch2.subhap$TOPMed_ID == 'k-0554'] <- 'K-0554'
batch2.subhap <- batch2.subhap[batch2.subhap$TOPMed_ID %in% pheno$subjid[pheno$Batch == 'II'], ]
batch2.subhap <- batch2.subhap[match(pheno$subjid[pheno$Batch=='II'], batch2.subhap$TOPMed_ID), ]

batch.subhap <- rbind(batch1.subhap, batch2.subhap)
batch.impute.h1b1g1 <- batch.subhap$H1B1G1
pheno <- pheno[pheno$H1B1G1 == batch.impute.h1b1g1, ]
pheno <- pheno[!is.na(pheno$H1B1G1), ]
