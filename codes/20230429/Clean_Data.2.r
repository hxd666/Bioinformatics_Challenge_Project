...
rs$rs6910507 <- ifelse(rs$rs6910507 %in% c('1|0', '1|1', '0|1'), 1, ifelse(rs$rs6910507 %in% c('1|1'), 2, 0))
...
output.filename <- '/restricted/projectnb/cte/Challenge_Project_2022/data/RNA/all_cte_meta_nmf_cleaned_additive.csv'
