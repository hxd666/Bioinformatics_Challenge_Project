...
batch1.subhap <- read.table('/restricted/projectnb/cte/Challenge_Project_2022/imputation/HLA/1st_batch/1st_batch.hla.types.txt',
                            header = T, as.is = T)
batch1.subhap <- batch1.subhap[,c(1,22:591)]
batch2.subhap <- read.table('/restricted/projectnb/cte/Challenge_Project_2022/imputation/HLA/2nd_batch/2nd_batch.hla.types.txt',
                            header = T, as.is = T)
batch2.subhap <- batch2.subhap[,c(1,22:591)]
...
save.image('/restricted/projectnb/cte/Challenge_Project_2022/xdhan/scripts/20230323/imputatoin.RData')
