...
# Load Data
stats_ds <- read.table('/restricted/projectnb/cte/Challenge_Project_2022/xdhan/scripts/20230124/results/Model1.Euro.assoc.txt',
                       header = T, as.is = T)
...
p_values_fn <- '/restricted/projectnb/cte/Challenge_Project_2022/xdhan/scripts/20230124/permutations/XXXX.permutation.P.values'
...
output_name <- '/restricted/projectnb/cte/Challenge_Project_2022/xdhan/scripts/20230124/p_adjust/XXXX.Model1.Euro.permutation.assoc.txt'
